...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { color: @habit.color, date: @habit.date, length: @habit.length, name: @habit.name, real: @habit.real, target: @habit.target } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { color: @habit.color, date: @habit.date, length: @habit.length, name: @habit.name, real: @habit.real, target: @habit.target } }
